...
```{r}
ggplot(melt, aes(x = qubit, y = n/reads_tot, color = study)) +
     geom_point(alpha = 0.5) +
     facet_wrap(~seq_date,
                nrow = 2,
                scales = 'free_x') +
     ...
     scale_color_manual(values = c('darkgreen', 
                                  ...
                                  'gray40', 
                                  'gold2')) +
     labs(y = '*trnL* taxa per read', x = 'Qubit') +
...
# ggsave(here('results', 'manuscript', 'supplemental',
#             paste0(plotID, '_Observed taxa, 1,000 read rarefaction.pdf')),
#        height = 4, width = 4)
```
```{r}
