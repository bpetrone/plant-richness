...
major.crop$major_crop[major.crop$agree] <- 1
major.crop$in_ref[major.crop$agree] <- 1

# In reference, but not a major crop: 2, light green
major.crop$major_crop[major.crop$no_crop_yes_ref] <- 0
...
major.crop$major_crop[major.crop$yes_crop_no_ref] <- 3
major.crop$in_ref[major.crop$yes_crop_no_ref] <- 0

# Convert to factor
major.crop <- mutate(major.crop,
                     across(c(major_crop, in_ref), factor))
```
...
Hmm -- need to figure out how to preserve fan layout with addition of gheatmap data
